...
+ はじめに {#get-started}
  ...
  + AIでよりスマートに作業 {#ai}
    ...
    + [ポッドキャストの作成](getting-started/podcast.md)
  + 作成と整理 {#create}
    ...
    + [紙からPDF](getting-started/scan-and-ocr.md)
  + 編集と強化 {#edit}
...
+ アクセシビリティシリーズ {#accessibility-tutorials}
  ...
  + [AcrobatでのアクセシブルなPDFの作成](accessibility-series/accessible-acrobat.md)
  + [タグ付けの基本](accessibility-series/basics-tagging.md)
  + [スキャンした文書](accessibility-series/scanned-documents.md)
  + [アクセシブルなフォームの作成](accessibility-series/create-accessible-forms.md)
  + [複雑なリスト](accessibility-series/complex-lists.md)
  + [複雑な表](accessibility-series/complex-tables.md)
...
+ AI搭載 {#ai-powered}
  ...
  + [Acrobat Studioとは](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/get-started/basics/acrobat-studio)
  ...
  + [ポッドキャストの作成](https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/get-started/ai/podcast)
...
+ Acrobat StudioのAnalyzer {#analyzer}
  ...
  + [ウェビナー](https://experienceleague.adobe.com/en/docs/events/acrobat-analyzer-webinars/overview){target=_blank}
+ 使用事例 {#use-cases}
  + [概要](use-cases/use-cases-overview.md)
  + 基幹業務 {#lob}
    + 財務 {#finance}
      + [概要](use-cases/lob/finance/finance-overview.md)
      + [インサイトから提供に至るまで、経営幹部が利用できる財務ドキュメントを準備する](use-cases/lob/finance/finance-insights.md)
    + HR {#hr}
  ...
  + 中央省庁 {#gov}
    ...
    + Acrobatでどこでも作業するための5つのヒント {#tips}
      ...
      + [ヒント#5 – モバイルでスキャンして編集](use-cases/gov/scan-and-edit-on-mobile.md)

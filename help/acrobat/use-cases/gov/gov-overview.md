---
title: 政府機関向けAcrobat
description: 連邦、州、地方政府向けに特別に設計されたAcrobat チュートリアルをご覧ください
...
連邦、州、地方自治体のために特別に設計されたAcrobat チュートリアルをご覧ください。

## Acrobatでどこでも作業するための 5 つのヒント
...
<div class="columns">
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/by-industry/gov/tips/5-tips-for-working-anywhere-with-acrobat-dc-for-government" title="Acrobatでどこでも作業するための 5 つのヒント（全 15:12）" target="_self" rel="referrer">
                        <img class="is-bordered-r-small" src="https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/by-industry/gov/media_15d041d3a4a509d11dc61c624a6f27e8101822337.png?width=400&format=webply&optimize=medium" alt="Acrobatでどこでも作業するための 5 つのヒント（全 15:12）"
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/by-industry/gov/tips/5-tips-for-working-anywhere-with-acrobat-dc-for-government" target="_self" rel="referrer" title="Acrobatでどこでも作業するための 5 つのヒント（全 15:12）">Acrobatでどこでも作業するための 5 つのヒント（全 15:12） </a>
                    </p>
                    <p class="is-size-6">Acrobatおよび関連するモバイルアプリでツールを使用して、どこからでも作業できるようにする方法を説明します</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Tip #1 - Get your tools">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/by-industry/gov/tips/get-your-tools" title="ヒント #1 - ツールを入手する" target="_self" rel="referrer">
                        <img class="is-bordered-r-small" src="https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/by-industry/gov/media_13fcba82130fff3cc46a1e2685fb5fa89fecad9e5.png?width=400&format=webply&optimize=medium" alt="ヒント #1 - ツールを入手する"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/document-cloud-learn/acrobat-learning/by-industry/gov/tips/get-your-tools" target="_self" rel="referrer" title="ヒント #1 - ツールを入手する"> ヒント #1 - ツールを入手する </a>
                    </p>
                    <p class="is-size-6">どこからでも作業を開始するための最初の手順は、Acrobat ツールおよびコンパニオンモバイルアプリを入手することです</p>
                </div>

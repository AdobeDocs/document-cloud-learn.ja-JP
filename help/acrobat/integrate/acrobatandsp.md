...
[Microsoft 365用Adobe Acrobat](https://appsource.microsoft.com/en-us/product/web-apps/adobeinc.adobe-document-cloud-pdf?tab=Overview)を使用して、[!DNL SharePoint]とAcrobatで文書ワークフローを合理化します。 [!DNL Microsoft 365]個のファイルをPDFに安全に変換し、[PDF文書を結合](https://www.adobe.com/jp/acrobat/online/merge-pdf.html){target="_blank"}して、1つのファイルに変換し、コメントを追加し、ページを並べ替えることができます。この操作は、[!DNL SharePoint]からオンラインで実行できます。
...
>[!VIDEO](https://video.tv.adobe.com/v/3409690?captions=jpn&quality=12&learn=on&hidetitle=true)

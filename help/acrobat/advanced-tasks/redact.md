...
墨消しツールを使用して、個人情報や機密情報をPDFから完全に削除する方法について説明します。 このチュートリアルでは、ドキュメントをアニメーション化して、ファイルに表示されない情報（コメント、メタデータ、非表示レイヤーなど）を削除する方法についても説明します。 機密性の高いコンテンツや非表示データを完全に削除することは、PDFの公開時に情報が渡されないように重要です。 このチュートリアルでは、[新しいAcrobatエクスペリエンス](../getting-started/new-experience.md)を使用します。

**お試しください：**&#x200B;今すぐ[ハンズオン](https://w.adobedemo.com/s/7MUInu){target="_blank"}を墨消しする方法をご確認ください。

...
+ 管理 {#admin-set-up}
   ...
   + はじめに {#getting-started-admin}
      + [管理者向けのセットアップと実行](admin/up-and-running-admin.md)
...
+ デジタル ID {#digital-id}
   ...
   + Intesi Group {#intesi}
      + [Intesi Group からデジタル ID を取得（高度）](digitalid/intesi-advanced.md)
...
+ 統合 {#integrations}
   ...
   + Workday {#workday}
      + [Workdayを使用したAdobe Signの設定](integrations/workday.md)
   + Marketo {#marketo}
      + [Salesforce およびMarketo用Adobe Signを使用した通知の送信](integrations/marketo-salesforce-sms.md)

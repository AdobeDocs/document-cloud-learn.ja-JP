...
+ はじめに {#getting-started}
   ...
   + Send {#getting-started-sending}
      ...
      + [Acrobat Sign 入門](sign-beginner-tutorials/new-sender.md)
      + [1 人の署名者に文書を送信](sign-beginner-tutorials/send-to-single-recipient.md)
      ...
      + [「コピーを作成」を使用する場合](sign-beginner-tutorials/create-a-copy.md)
...
+ 高度なタスク {#advanced-tasks}
   ...
   + Send {#advanced-tasks-sending}
      ...
      + [カスタムワークフローの作成](https://experienceleague.adobe.com/en/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-managing/creating-a-report)
...
+ 管理者 {#admin-set-up}
   ...
   + はじめに {#getting-started-admin}
      + [新しい管理者向けの入門](admin/get-started-admin.md)
      ...
      + [契約書を変更の設定と管理](admin/configure-modify-agreement.md)
...
+ モバイル {#mobile}
   ...
   + モバイルチュートリアル {#mobile-tutorials}
      ...
      + [モバイルフレンドリーな表示](mobile/mobile-friendly.md)
      + [モバイル対応ビューの作成](mobile/create-mobile-friendly.md)
